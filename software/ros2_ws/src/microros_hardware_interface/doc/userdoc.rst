...
1. To check that *CarlikeBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch microros_hardware_interface view_robot.launch.py
...
2. To start *CarlikeBot* example open a terminal, source your ROS2-workspace and execute its launch file with
   ...
   .. code-block:: shell
    ...
    ros2 launch microros_hardware_interface carlikebot.launch.py remap_odometry_tf:=true
...
5. If everything is fine, now you can send a command to *bicycle_steering_controller* using ROS 2 CLI:
   ...
   .. code-block:: shell
      ...
      [MicroSystemHardware]: Got position command: 0.03 for joint 'virtual_front_wheel_joint'.
      [MicroSystemHardware]: Got velocity command: 20.01 for joint 'virtual_rear_wheel_joint'.
...
* URDF file: `core.urdf.xacro <https://github.com/ros-controls/ros2_control_demos/tree/{REPOS_FILE_BRANCH}/example_11/description/urdf/core.urdf.xacro>`__

  * Description: `core.urdf.xacro <https://github.com/ros-controls/ros2_control_demos/tree/{REPOS_FILE_BRANCH}/example_11/description/urdf/core.urdf.xacro>`__
