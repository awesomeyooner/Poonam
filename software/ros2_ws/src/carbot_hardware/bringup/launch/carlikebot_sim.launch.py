...
def generate_launch_description():
    ...
    robot_sim_config = PathJoinSubstitution(
        [
            FindPackageShare("carbot_hardware"),
            "config",
    ...
    control_node_remapped = Node(
        ...
        parameters=[robot_controllers, robot_sim_config],
        output="both",
        remappings=[
            ("~/robot_description", "/robot_description"),
            ("/effort_controller/tf_odometry", "/tf"),
        ],
    ...
    robot_bicycle_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["effort_controllers/JointGroupEffortController", "--controller-manager", "/controller_manager"],
    )
